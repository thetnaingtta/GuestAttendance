    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="25px" height="25px">
        <radialGradient id="U82P9tORUQOQwN6q6fq4Ja" cx="28.686" cy="21.073" r="17.032" gradientUnits="userSpaceOnUse">
          <stop offset=".683" stop-color="#c24717"/><stop offset=".756" stop-color="#bb4417"/><stop offset=".862" stop-color="#a83b18"/>
          <stop offset=".987" stop-color="#892c1a"/><stop offset="1" stop-color="#852a1a"/></radialGradient>
          ...
          gradientUnits="userSpaceOnUse"><stop offset=".683" stop-color="#c24717"/>
          <stop offset=".756" stop-color="#bb4417"/><stop offset=".862" stop-color="#a83b18"/><stop offset=".987" 
          stop-color="#892c1a"/><stop offset="1" stop-color="#852a1a"/>
          ...
          <linearGradient id="U82P9tORUQOQwN6q6fq4Jc" x1="12.838" x2="34.961" y1="7.678" y2="40.027" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#fed100"/><stop offset="1" stop-color="#e36001"/>
